    ...
    <div style="border-bottom: 0.8px solid:black;" class="contenedor">
             <h3>Cine</h3><br>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <ul class="nav">
                       <li class="nav-item">
                           <a class="nav-link " href="#">Nuevos Y destacados</a>
                       </li>
                       <li class="nav-item">
                           <a class="nav-link" href="#">Cerca de la Meta</a>
                       </li>
                       <li class="nav-item">
